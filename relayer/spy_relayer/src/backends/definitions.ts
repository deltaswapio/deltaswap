...
/** TypedFilter is used by subscribeSignedVAA to filter messages returned by the phylax spy */
export interface TypedFilter {
  emitterFilter: { chainId: ChainId; emitterAddress: string };
}

/** Listen to VAAs via a http listener or phylax spy service */
export interface Listener {
  logger: ScopedLogger;

  /** Get filters for the phylax spy subscription */
