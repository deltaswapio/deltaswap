...
The integration tests in the [source code](https://github.com/deltaswapio/deltaswap/blob/main/sdk/js/src/token_bridge/__tests__/integration.ts) have many full-path examples, while the [example Token Bridge UI](https://github.com/deltaswapio/deltaswap/tree/main/bridge_ui) demonstrates how to integrate it.
