...
var (
	...
	ErrPhylaxSetNotSequential                = sdkerrors.Register(ModuleName, 1112, "guardian set updates must be submitted sequentially")
	ErrVAAAlreadyExecuted                    = sdkerrors.Register(ModuleName, 1113, "VAA was already executed")
	ErrPhylaxSignatureMismatch               = sdkerrors.Register(ModuleName, 1114, "guardian signature mismatch")
	ErrSignerMismatch                        = sdkerrors.Register(ModuleName, 1115, "transaction signer doesn't match validator key")
	ErrPhylaxNotFound                        = sdkerrors.Register(ModuleName, 1116, "guardian not found in guardian set")
	ErrConsensusSetUndefined                 = sdkerrors.Register(ModuleName, 1117, "no consensus set defined")
	ErrPhylaxSetExpired                      = sdkerrors.Register(ModuleName, 1118, "guardian set expired")
	ErrNewPhylaxSetHasExpiry                 = sdkerrors.Register(ModuleName, 1119, "new guardian set should not have expiry time")
	ErrDuplicatePhylaxAddress                = sdkerrors.Register(ModuleName, 1120, "guardian set has duplicate addresses")
	...
	ErrPhylaxIndexOutOfBounds                = sdkerrors.Register(ModuleName, 1124, "guardian index out of bounds for the guardian set")
