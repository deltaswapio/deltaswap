...
import (
	...
	deltaswapkeeper "github.com/deltaswapio/deltachain/x/deltaswap/keeper"
)
...
type Keeper struct {
	...
	deltaswapKeeper *deltaswapkeeper.Keeper
...
func NewKeeper(
	...
	storeKey storetypes.StoreKey,
	wasmKeeper *wasmkeeper.Keeper,
	wormholeKeeper *deltaswapkeeper.Keeper,
	retriesOnTimeout uint8,
	forwardTimeout time.Duration,
) *Keeper {
	return &Keeper{
		...
		deltaswapKeeper:  wormholeKeeper,
...
func (k Keeper) OnRecvPacket(
	...
	ibcTranslatorContract := k.deltaswapKeeper.GetIbcComposabilityMwContract(ctx)
