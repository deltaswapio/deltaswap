...
export const Config = {
  encode(message: Config, writer: Writer = Writer.create()): Writer {
    if (message.phylax_set_expiration !== 0) {
      writer.uint32(8).uint64(message.phylax_set_expiration);
    }
  ...
  fromJSON(object: any): Config {
    const message = { ...baseConfig } as Config;
    if (
      object.phylax_set_expiration !== undefined &&
      object.phylax_set_expiration !== null
    ) {
      message.phylax_set_expiration = Number(object.phylax_set_expiration);
    } else {
      message.phylax_set_expiration = 0;
    }
    if (
  ...
  toJSON(message: Config): unknown {
    const obj: any = {};
    message.phylax_set_expiration !== undefined &&
      (obj.phylax_set_expiration = message.phylax_set_expiration);
  ...
  fromPartial(object: DeepPartial<Config>): Config {
    ...
    if (
      ...
      message.phylax_set_expiration = object.phylax_set_expiration;
    } else {
      message.phylax_set_expiration = 0;
    }
    if (
