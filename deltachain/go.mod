...
replace (
	...
	github.com/CosmWasm/wasmd v0.30.0 => github.com/deltaswapio/wasmd v0.30.0-wormchain-2
	github.com/cosmos/cosmos-sdk => github.com/deltaswapio/cosmos-sdk v0.45.9-wormhole-4
	github.com/deltaswapio/deltaswap/sdk => ../sdk
