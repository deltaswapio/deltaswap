...
func CmdCreateAllowedAddress() *cobra.Command {
	cmd := &cobra.Command{
		Use:     "create-allowed-address [deltachain-address] [human-readable-name-of-key]",
		Short:   "Allowlist an address to be able to submit tx to deltachain. Must be submitted by a validator account.",
