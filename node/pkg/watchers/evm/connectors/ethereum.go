...
func (e *EthereumBaseConnector) GetCurrentPhylaxSetIndex(ctx context.Context) (uint32, error) {
	return e.caller.GetCurrentPhylaxSetIndex(&ethBind.CallOpts{Context: ctx})
}

func (e *EthereumBaseConnector) GetPhylaxSet(ctx context.Context, index uint32) (ethAbi.StructsPhylaxSet, error) {
