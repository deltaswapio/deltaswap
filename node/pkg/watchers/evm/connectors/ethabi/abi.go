...
//
// Solidity: function verifySignatures(bytes32 hash, (bytes32,bytes32,uint8,uint8)[] signatures, (address[],uint32) phylaxSet) pure returns(bool valid, string reason)
func (_Abi *AbiCaller) VerifySignatures(opts *bind.CallOpts, hash [32]byte, signatures []StructsSignature, phylaxSet StructsPhylaxSet) (struct {
	Valid  bool
	Reason string
}, error) {
	var out []interface{}
	err := _Abi.contract.Call(opts, &out, "verifySignatures", hash, signatures, phylaxSet)
...
//
// Solidity: function verifySignatures(bytes32 hash, (bytes32,bytes32,uint8,uint8)[] signatures, (address[],uint32) phylaxSet) pure returns(bool valid, string reason)
func (_Abi *AbiSession) VerifySignatures(hash [32]byte, signatures []StructsSignature, phylaxSet StructsPhylaxSet) (struct {
	Valid  bool
	Reason string
}, error) {
	return _Abi.Contract.VerifySignatures(&_Abi.CallOpts, hash, signatures, phylaxSet)
}

// VerifySignatures is a free data retrieval call binding the contract method 0xa0cce1b3.
//
// Solidity: function verifySignatures(bytes32 hash, (bytes32,bytes32,uint8,uint8)[] signatures, (address[],uint32) phylaxSet) pure returns(bool valid, string reason)
func (_Abi *AbiCallerSession) VerifySignatures(hash [32]byte, signatures []StructsSignature, phylaxSet StructsPhylaxSet) (struct {
	Valid  bool
	Reason string
}, error) {
	return _Abi.Contract.VerifySignatures(&_Abi.CallOpts, hash, signatures, phylaxSet)
...
//
// Solidity: function initialize(address[] initialPhylaxs, uint16 chainId, uint16 governanceChainId, bytes32 governanceContract) returns()
func (_Abi *AbiTransactor) Initialize(opts *bind.TransactOpts, initialPhylaxs []common.Address, chainId uint16, governanceChainId uint16, governanceContract [32]byte) (*types.Transaction, error) {
	return _Abi.contract.Transact(opts, "initialize", initialPhylaxs, chainId, governanceChainId, governanceContract)
}

// Initialize is a paid mutator transaction binding the contract method 0xf6079017.
//
// Solidity: function initialize(address[] initialPhylaxs, uint16 chainId, uint16 governanceChainId, bytes32 governanceContract) returns()
func (_Abi *AbiSession) Initialize(initialPhylaxs []common.Address, chainId uint16, governanceChainId uint16, governanceContract [32]byte) (*types.Transaction, error) {
	return _Abi.Contract.Initialize(&_Abi.TransactOpts, initialPhylaxs, chainId, governanceChainId, governanceContract)
}

// Initialize is a paid mutator transaction binding the contract method 0xf6079017.
//
// Solidity: function initialize(address[] initialPhylaxs, uint16 chainId, uint16 governanceChainId, bytes32 governanceContract) returns()
func (_Abi *AbiTransactorSession) Initialize(initialPhylaxs []common.Address, chainId uint16, governanceChainId uint16, governanceContract [32]byte) (*types.Transaction, error) {
	return _Abi.Contract.Initialize(&_Abi.TransactOpts, initialPhylaxs, chainId, governanceChainId, governanceContract)
}
