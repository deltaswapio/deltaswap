...
func chainList() []chainConfigEntry {
	return []chainConfigEntry{
		...
		{emitterChainID: vaa.ChainIDTron, dailyLimit: 5_000_000, bigTransactionSize: 500_000},
		{emitterChainID: vaa.ChainIDPlanq, dailyLimit: 5_000_000, bigTransactionSize: 500_000},
		...
		{emitterChainID: vaa.ChainIDDeltachain, dailyLimit: 500_000, bigTransactionSize: 50_000},
	}
}
