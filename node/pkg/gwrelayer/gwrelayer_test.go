...
func Test_shouldPublishToIbcTranslator(t *testing.T) {
	...
	for _, tc := range tests {
		t.Run(string(tc.label), func(t *testing.T) {
			result, err := shouldPublishToIbcTranslator(tc.payload, vaa.ChainIDDeltachain, targetAddress)
...
func Test_shouldPublishToTokenBridge(t *testing.T) {
	...
	require.Equal(t, tokenBridgeAddress, "delta1466nf3zuxpya8q9emxukd7vftaf6h4psr0a07srl5zw74zh84yjq4lyjmh")
	...
	tests := []Test{
		...
		{label: "deltachain", chain: vaa.ChainIDDeltachain, address: addr("aeb534c45c3049d380b9d9b966f9895f53abd4301bfaff407fa09dea8ae7a924"), payload: []byte{}, result: false},
