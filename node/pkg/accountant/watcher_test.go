...
func TestParseWasmObservationFromTestTool(t *testing.T) {
	...
	xfer, err := parseEvent[WasmObservation](logger, event, "wasm-Observation", "delta1466nf3zuxpya8q9emxukd7vftaf6h4psr0a07srl5zw74zh84yjq4lyjmh")
	require.NoError(t, err)
...
func TestParseWasmObservationError(t *testing.T) {
	...
	evt, err := parseEvent[WasmObservationError](logger, event, "wasm-ObservationError", "delta1466nf3zuxpya8q9emxukd7vftaf6h4psr0a07srl5zw74zh84yjq4lyjmh")
	require.NoError(t, err)
